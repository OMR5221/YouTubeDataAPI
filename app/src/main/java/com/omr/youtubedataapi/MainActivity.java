...
public class MainActivity extends Activity
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
         ...
         * @throws IOException
         */
        private List<String> getPlaylistInfo() throws IOException {
            ...
            if (playlists != null) {
                for (int i = 0; i < playlists.size(); i++) {
                    ...
                    playlistInfo.add("This Playlist's ID is " + playlist.getId() + ". " +
                            "and it has " + playlist.getContentDetails() + " " + playlist.getSnippet().getTitle());
                }
            }
            return playlistInfo;
        }
